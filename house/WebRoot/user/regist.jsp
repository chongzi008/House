  ...
  <body>
   ...
   <tr><td>用户名：</td><td><input type="text" id="username" name="username"/></td></tr>
    <tr><td>密码：</td><td><input type="text" name="upassword"></td></tr>
      <tr><td>手机号码：</td><td><input type="text" name="utelephone"></td></tr>
        <tr><td>微信号码：</td><td><input type="text" name="uwechat"></td></tr>
        <tr><td>头像</td><td><input type="file" name="upload"/></td></tr>
