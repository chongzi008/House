...
<body>
<form id=form1 name=form1 action="${pageContext.request.contextPath }/news_update.action" method="post" enctype="multipart/form-data">		
	
	<div id="container">
		<div id="nav_links">
			当前位置：新闻管理&nbsp;>&nbsp;<span style="color: #1A5CC6;">修改新闻</span>
			<input type="hidden" value="${newInfo.house.hid }" name="hid" id="hid">
			<input type="hidden" value="${newInfo.nid }" name="nid" id="nid">
			<div id="page_close">
			</div>
		</div>
		<div class="ui_content">
			<table  cellspacing="0" cellpadding="0" width="100%" align="left" border="0">
				...
				<tr>
					...
					<td class="ui_text_lt">
						<input type="text" class="ui_input_txt02" name="ntitle" value="${newInfo.ntitle }"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td class="ui_text_lt">
						<textarea  rows="5" cols="25" name="ncontent" >${newInfo.ncontent }</textarea>
					</td>
				</tr>
